/**
 * Utilidades de trimestre para el browser.
 * Mantener en sync con packages/utils/src/quarters.ts (@cobrai/utils).
 */
...
function getAgingBucket(dueDate: Date, today: Date = new Date()): AgingBucket {

...
```bash
INIT=$(node "/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/templates/spec.md.

...
```
Agent(
  prompt="Read /Users/gustavo.moreno/Documents/personal info/Renova/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/templates/VALIDATION.md`

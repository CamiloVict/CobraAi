...
```bash
INIT=$(node "/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/bin/gsd-tools.cjs" commit \

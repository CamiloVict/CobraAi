...
```
Agent(
  prompt="Read /Users/gustavo.moreno/Documents/personal info/Renova/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gustavo.moreno/Documents/personal info/Renova/.claude/get-shit-done/templates/SECURITY.md`

...
The keys live in `.claude/settings.json` (project) or `/Users/gustavo.moreno/Documents/personal info/Renova/.claude/settings.json` (global) — **not** in `.planning/config.json`:
